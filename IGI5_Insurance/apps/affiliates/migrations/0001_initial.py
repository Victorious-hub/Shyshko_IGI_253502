...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('Medical Insurance', 'MI'), ('Auto Insurance', 'AI'), ('Home Insurance', 'HI'), ('Life Insurance', 'LI'), ('Travel Insurance', 'TI'), ('Business Insurance', 'BI')], default='Medical Insurance', max_length=255)),
                ('description', models.TextField()),
            ],
            options={
